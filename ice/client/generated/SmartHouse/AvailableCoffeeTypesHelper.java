...
/**
 * Helper class for marshaling/unmarshaling AvailableCoffeeTypes.
 **/
public final class AvailableCoffeeTypesHelper
{
    ...
    public static void write(com.zeroc.Ice.OutputStream ostr, int tag, CoffeeType[] v)
    {
        if(ostr.writeOptional(tag, com.zeroc.Ice.OptionalFormat.FSize))
        {
            ...
            AvailableCoffeeTypesHelper.write(ostr, v);
            ostr.endSize(pos);
        }
    }
    ...
    public static java.util.Optional<CoffeeType[]> read(com.zeroc.Ice.InputStream istr, int tag)
    {
        if(istr.readOptional(tag, com.zeroc.Ice.OptionalFormat.FSize))
        {
            istr.skip(4);
            CoffeeType[] v;
            v = AvailableCoffeeTypesHelper.read(istr);
